...
public class UserService {
    ...
    public void setDisable(DisabledCredentials disabledCredentials) {
        userRepository.updateDisabled(disabledCredentials.getUserId(), disabledCredentials.isDisabled());
    }
